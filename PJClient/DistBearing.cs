...
namespace PJClient
{
	public class DistBearing
	{
		public DistBearing ()
		{
			//DistBearing.MaidenheadLocator mh = new DistBearing.MaidenheadLocator ();
		}
		/// <summary>
		...
		//{
			...
			public LatLong LocatorToLatLong(string locator)
			{
			...
			public string LatLongToLocator(LatLong ll)
			{
			...
			/// <returns>Locator string</returns>
			public string LatLongToLocator(LatLong ll, int Ext)
			{
			...
			/// <returns>Locator string</returns>
			public string LatLongToLocator(double Lat, double Long)
			{
			...
			/// <param name="Ext">Extra precision (0, 1, 2)</param>
			/// <returns>Locator string</returns>
			public string LatLongToLocator(double Lat, double Long, int Ext)
			{
				//int v;
				string locator = "";
			...
			public double Azimuth(string A, string B)
			{
			...
			/// <param name="B">End LatLong structure</param>
			/// <returns>Azimuth in degrees</returns>
			public double Azimuth(LatLong A, LatLong B)
			{
				if (A.CompareTo(B) == 0) return 0;
