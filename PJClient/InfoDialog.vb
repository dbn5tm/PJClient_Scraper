...
Public Class InfoDialog
        ...
        Try
            Dim xInfo = <?xml version="1.0"?>
                        <Info>
                            ...
                            <WSJTLog><%= Me.DBPathTextBox.Text %></WSJTLog>
                            <history><%= 0 %></history>
                            ...
                            <Call3WSJTX><%= Me.Call3WSJTXTextBox.Text %></Call3WSJTX>
                            <useSQLiteDB><%= Me.UseSQLiteCheckBox.Checked %></useSQLiteDB>
                        </Info>
    ...
    Private Sub BrowseWSJTLogButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BrowseWSJTLogButton.Click
        ...
        If Windows.Forms.DialogResult.OK Then
            If MyOpenFileDialog.FileName <> "" Then Me.DBPathTextBox.Text = MyOpenFileDialog.FileName
    ...
    Private Sub MyOpenFileDialog_FileOk(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyOpenFileDialog.FileOk
        Me.DBPathTextBox.Text = MyOpenFileDialog.FileName
    End Sub

    Private Sub WSJTLogTextBox_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DBPathTextBox.Click
    ...
    Private Sub UseWSJTLogCheckBox_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UseWSJTLogCheckBox.CheckedChanged
        If sender.checked Then
            If Me.DBPathTextBox.Text = "" Then
                Me.DBPathTextBox.Text = findWSJT()
            End If
            UseSQLiteCheckBox.Checked = False
        End If
    End Sub
    ...
    Private Sub BrowseWSJTXCall3Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BrowseWSJTXCall3Button.Click
        MyFolderBrowserDialog.ShowDialog()
        If Windows.Forms.DialogResult.OK Then
            Me.Call3WSJTXTextBox.Text = MyFolderBrowserDialog.SelectedPath & "\CALL3.TXT"


        End If
    End Sub

    Private Sub UseSQLiteCheckBox_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UseSQLiteCheckBox.CheckedChanged
        If sender.checked = True Then
            UseWSJTLogCheckBox.Checked = False
        End If
    End Sub
End Class
